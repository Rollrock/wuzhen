...
-(void)touchUp:(id)sender
{
    ...
    {      
        ...
        vc.urlStr = @"http://www.999dh.net/tour/wuzhen/time.html";
    ...
    {
        MyWebViewController * vc = [[[MyWebViewController alloc]initWithNibName:nil bundle:nil]autorelease];
        vc.urlStr = @"http://www.999dh.net/tour/wuzhen/traffic.html";
    ...
    {
        MyWebViewController * vc = [[[MyWebViewController alloc]initWithNibName:nil bundle:nil]autorelease];
        vc.urlStr = @"http://www.999dh.net/tour/wuzhen/zhaoshang.html";
    ...
    {
        MyWebViewController * vc = [[[MyWebViewController alloc]initWithNibName:nil bundle:nil]autorelease];
        vc.urlStr = @"http://www.999dh.net/tour/wuzhen/ticket.html";
    ...
    {
        MyWebViewController * vc = [[[MyWebViewController alloc]initWithNibName:nil bundle:nil]autorelease];
        vc.urlStr = @"http://www.999dh.net/tour/wuzhen/shopping.html";
